...
class HistoryViewModel(application: Application) : AndroidViewModel(application), CoroutineScope {
    ...
    fun refresh() {
        ...
        launch {
            ...
            val data = db.orderDao().selectHistories(GlobalData.username, today)
